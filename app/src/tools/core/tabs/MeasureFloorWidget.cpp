...
#include "ui_MeasureFloorWidget.h"
...
MeasureFloorWidget::~MeasureFloorWidget()
{
    delete m_ui;
}
...
const QString MeasureFloorWidget::GetSubSchemaDefaultFileName() const
{
...
void MeasureFloorWidget::OverlayMaskClicked()
{
    ShowImage();
}
