...
#ifndef CALIBRATCAMERARESULTSMAPPER_H
#define CALIBRATCAMERARESULTSMAPPER_H
...
class CalibrateCameraResultsMapper: public ConfigKeyMapper
{
    Q_OBJECT
...
#endif // CALIBRATCAMERARESULTSMAPPER_H
