...
#ifndef CAMERACOLLECTIONTOOLWIDGET_H
#define CAMERACOLLECTIONTOOLWIDGET_H
...
class CameraCollectionToolWidget : public CollectionToolWidget
{
    Q_OBJECT

public:
    explicit CameraCollectionToolWidget( CameraHardware& cameraHardware,
                                   QWidget* parent,
                                   MainWindow& mainWindow );
    ~CameraCollectionToolWidget();
...
#endif // CAMERACOLLECTIONTOOLWIDGET_H
