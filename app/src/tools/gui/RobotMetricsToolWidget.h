...
#ifndef ROBOTMETRICSTOOLWIDGET_H
#define ROBOTMETRICSTOOLWIDGET_H
...
namespace Ui
{
    class RobotMetricsToolWidget;
}

class RobotMetricsToolWidget : public Tool
{
    Q_OBJECT

public:
    explicit RobotMetricsToolWidget( QWidget* parent = 0 );
...
#endif // ROBOTMETRICSTOOLWIDGET_H
