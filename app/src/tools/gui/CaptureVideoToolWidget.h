...
#ifndef CAPTUREVIDEOTOOLWIDGET_H
#define CAPTUREVIDEOTOOLWIDGET_H
 ...
 *
 */
class CaptureVideoToolWidget : public Tool
{
    Q_OBJECT
...
public:
    explicit CaptureVideoToolWidget( CameraHardware& cameraHardware, QWidget* parent = 0 );
    ~CaptureVideoToolWidget();
