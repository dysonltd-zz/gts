...
#ifndef POSTPROCESSTOOLWIDGET_H
#define POSTPROCESSTOOLWIDGET_H
...
namespace Ui
{
    class PostProcessToolWidget;
}

class PostProcessToolWidget : public Tool
{
    Q_OBJECT

public:
    explicit PostProcessToolWidget( QWidget* parent = 0 );
...
private:
    Ui::PostProcessToolWidget* m_ui;

    TrackModel *m_resultsModel;
    QItemSelectionModel *m_selectionModel;
};

#endif // POSTPROCESSTOOLWIDGET_H
