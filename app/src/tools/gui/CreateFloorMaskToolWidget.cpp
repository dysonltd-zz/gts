...
void CreateFloorMaskToolWidget::BtnCombinePartsClicked()
{
...
void CreateFloorMaskToolWidget::BtnCreateMaskClicked()
{
...
bool CreateFloorMaskToolWidget::ExportFloorPlanParts( const WbConfig& config )
{
...
bool CreateFloorMaskToolWidget::ImportFloorMaskParts( const WbConfig& config )
{
    bool successful = true;
...
WbConfig CreateFloorMaskToolWidget::GetFloorPlanConfig()
{
    return GetCurrentConfig().GetParent().GetSubConfig( FloorPlanSchema::schemaName );
}

void CreateFloorMaskToolWidget::CreateFloorMaskSingle()
{
    WbConfig config = GetCurrentConfig();
...
void CreateFloorMaskToolWidget::CreateFloorMaskMulti()
{
...
void CreateFloorMaskToolWidget::Stitch(KeyId camRoot)
{
